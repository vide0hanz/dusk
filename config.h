...
static const char *fonts[]               = { "monospace:style=semibold:size=10" };
static       char dmenufont[]            = "monospace:size=12";

static char dmenunormfgcolor[] = "#FFF7D4";
static char dmenunormbgcolor[] = "#0f0f0f";
static char dmenuselfgcolor[] = "#282828";
static char dmenuselbgcolor[] = "#8ec07c";
...
static char *colors[SchemeLast][4] = {
	...
	[SchemeNorm]         = { "#FFF7D4", "#0f0f0f", "#282828", "norm" },
	[SchemeSel]          = { "#282828", "#b16286", "#8ec07c", "sel" },
	[SchemeTitleNorm]    = { "#FFF7D4", "#0f0f0f", "#282828", "titlenorm" },
	[SchemeTitleSel]     = { "#282828", "#b16286", "#8ec07c", "titlesel" },
	[SchemeWsNorm]       = { "#FFF7D4", "#0f0f0f", "#000000", "wsnorm" },
	[SchemeWsVisible]    = { "#FFF7D4", "#0f0f0f", "#000000", "wsvis" },
	[SchemeWsSel]        = { "#282828", "#8ec07c", "#000000", "wssel" },
	[SchemeWsOcc]        = { "#fabd2f", "#282828", "#000000", "wsocc" },
	[SchemeHidNorm]      = { "#928374", "#222222", "#282828", "hidnorm" },
	[SchemeHidSel]       = { "#d79921", "#111111", "#000000", "hidsel" },
	[SchemeUrg]          = { "#fb4934", "#222222", "#cc241d", "urg" },
  ...
  [SchemeFlexInaDWDLC] = { "#C6BDBD", "#003333", "#003333", "norm.DWDLC" },
	...
	[SchemeFlexSelTTMIC] = { "#FFF7D4", "#C91717", "#C91717", "sel.TTMIC" }, [SchemeFlexSelFloat] = { "#FFF7D4", "#5C415C", "#5C415C", "sel.float" },
};
...
static const Rule clientrules[] = {
	...
	{ .class = "Steam", .workspace = "9" },
	{ .class = "steam_app_", .workspace = "9", .flags = SteamGame },
...
#define BKSL PwrlBackslash
#define FWSL PwrlForwardSlash
#define RARW PwrlRightArrow 
#define LARW PwrlLeftArrow
#define PSLD PwrlSolid
#define RSLD PwrlSolidRev
static const BarRule barrules[] = {
	...
	{ -1,       0,     0,       0,   5,   PWRL,  BAR_ALIGN_LEFT,         size_workspaces,          draw_workspaces,         click_workspaces,         hover_workspaces,         "workspaces" },
	{  0,       0,     0,       5,   5,   0,     BAR_ALIGN_RIGHT,        size_systray,             draw_systray,            click_systray,            NULL,                     "systray" },
	{  0,       0,     0,       0,   0,   LARW,  BAR_ALIGN_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{ -1,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_LEFT,         size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{ -1,       0,     5,       0,   5,   0,     BAR_ALIGN_LEFT,         size_ltsymbol,            draw_ltsymbol,           click_ltsymbol,           NULL,                     "layout" },
	{ -1,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_LEFT,         size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	...
	{  0,       0,     7,       5,   5,   1,     BAR_ALIGN_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "status1" },
	{  0,       0,     0,       0,   0,   BKSL,  BAR_ALIGN_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
...
static Key keys[] = {
	...
	{ KeyPress,   MODKEY|Ctrl,                  XK_Down,         placedir,               {.i = 3 } }, // swap places wi1th the client window on the immediate down of the current client
